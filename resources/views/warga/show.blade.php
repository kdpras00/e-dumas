    ...
    <div class="max-w-7xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-white md:ml-2">Detail Pengaduan</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-3xl shadow-2xl border border-white/20 overflow-hidden mb-8">
                    <!-- Header Title -->
                    <div class="px-8 py-10 border-b border-gray-100">
                        <h2 class="text-3xl font-bold text-blue-900 tracking-wide">Detail Laporan</h2>
                    </div>
                            ...
                            <div class="bg-blue-50/50 p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="w-full bg-white border border-gray-400 text-gray-900 text-sm rounded-lg p-3 font-bold shadow-sm font-mono">
