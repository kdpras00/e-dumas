...
<div class="container mx-auto px-4 py-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-white md:ml-2">Master User</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-3xl shadow-2xl mb-8 relative overflow-hidden border border-white/20">
        <div class="p-10 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold text-blue-900 tracking-wide">Master User</h1>
                <p class="text-gray-500 mt-1 text-sm">Kelola data pengguna aplikasi</p>
            </div>
            @if(auth()->user()->user_level_id == 3)
            <a href="{{ route('admin.users.create') }}" class="bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-blue-500/30 transition transform hover:-translate-y-0.5 flex items-center">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-blue-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                @php
                                    $levelColor = match($user->user_level_id) {
                                        3 => 'text-purple-600',
                                        2 => 'text-blue-600',
                                        4 => 'text-yellow-600',
                                ...
                                @endphp
                                <span class="text-xs font-bold {{ $levelColor }} uppercase tracking-wider">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex justify-center space-x-2">
                                    <a href="{{ route('admin.users.show', $user->id) }}" class="text-green-600 hover:text-green-800 transition p-1 rounded-full hover:bg-green-100" title="Lihat Detail">
