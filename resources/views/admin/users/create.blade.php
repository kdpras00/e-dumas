    ...
    <div class="max-w-4xl mx-auto">
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.users.index') }}" class="inline-flex items-center text-sm font-medium text-blue-100 hover:text-white transition">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-white md:ml-2">Tambah User</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            <div class="px-8 py-8 border-b border-gray-100">
                <h2 class="text-2xl font-bold text-blue-900">Tambah User Baru</h2>
                <p class="text-gray-500 text-sm mt-1">Silahkan isi form dibawah ini untuk menambahkan user baru.</p>
            </div>
