...
<div class="container mx-auto px-4 py-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Master Kategori</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-blue-700 rounded-2xl shadow-lg p-8 mb-8 text-white relative overflow-hidden">
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold tracking-wide">Master Kategori</h1>
                <p class="text-blue-100 mt-1 text-sm">Kelola kategori pengaduan masyarakat</p>
            </div>
            <a href="{{ route('admin.categories.create') }}" class="bg-white text-blue-700 font-bold py-3 px-6 rounded-xl shadow-lg hover:bg-blue-50 hover:shadow-xl transition transform hover:-translate-y-0.5 flex items-center">
