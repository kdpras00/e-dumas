    ...
    <div class="max-w-2xl mx-auto">
        ...
        <nav class="flex mb-8" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center text-sm font-medium text-blue-100 hover:text-white transition">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-white md:ml-2">Edit Kategori</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-br from-blue-600 to-blue-800 px-8 py-6">
                ...
                <p class="text-blue-100 text-sm mt-1">Perbarui informasi kategori pengaduan.</p>
            </div>
                ...
                <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="relative">
                            ...
                            <input class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition duration-200" id="kategori" type="text" name="kategori" value="{{ $category->kategori }}" required>
                        </div>
                    </div>
