    ...
    <div class="max-w-2xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-white md:ml-2">Tambah RT</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            <div class="px-8 py-8 border-b border-gray-100">
                <h2 class="text-2xl font-bold text-blue-900">Tambah RT Baru</h2>
                <p class="text-gray-500 text-sm mt-1">Silahkan isi form dibawah ini untuk menambahkan RT baru.</p>
            </div>
