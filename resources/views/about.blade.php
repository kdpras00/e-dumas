...
<div class="w-full">
    <!-- Header Section -->
    <div class="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white pt-40 pb-24 overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row gap-12 items-center">
                ...
                <div class="md:w-1/2">
                    <div class="relative">
                        ...
                        <div class="relative bg-white p-10 rounded-3xl shadow-xl space-y-8">
